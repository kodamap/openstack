install
network --bootproto=static --hostname=controller --device=eth0 --gateway=192.168.101.1 --ip=192.168.101.11 --nameserver=192.168.101.1 --netmask=255.255.255.0 --activate
