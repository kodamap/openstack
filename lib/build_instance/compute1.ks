install
network --bootproto=static --hostname=compute1 --device=eth0 --gateway=192.168.101.1 --ip=192.168.101.12 --nameserver=192.168.101.1 --netmask=255.255.255.0 --activate
