...
echo
echo "getting image cirros-0.3.5-x86_64-disk.img"
echo

wget -P /tmp/images http://download.cirros-cloud.net/0.3.5/cirros-0.3.5-x86_64-disk.img
...
openstack image create "cirros" \
  --file /tmp/images/cirros-0.3.5-x86_64-disk.img \
