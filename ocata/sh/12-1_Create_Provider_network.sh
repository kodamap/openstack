...
create_provider_network () {
  ...
  PROVIDER_NETWORK_CIDR="10.250.241.0/24"
  START_IP_ADDRESS="10.250.241.101"
  END_IP_ADDRESS="10.250.241.250"
  DNS_RESOLVER="8.8.8.8"
  PROVIDER_NETWORK_GATEWAY="10.250.241.1"
  ...
  openstack subnet create --network provider \
    ...
    --subnet-range ${PROVIDER_NETWORK_CIDR} provider-subnet
